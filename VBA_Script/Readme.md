...
## Important note
This script has been specifically designed to work with instances of the MPSPLib library available at https://github.com/INSISOC/MPSPLIBtoMPP. It is not guaranteed to work with other types of .mpp files.
